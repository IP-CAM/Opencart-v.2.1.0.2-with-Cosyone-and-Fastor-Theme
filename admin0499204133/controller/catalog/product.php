...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			if ($result['special']){
				$profit = $result['special'] - $result['my_purchase_price'];
			}else{
				$profit = $result['price'] - $result['my_purchase_price'];
			}
			$profit = $profit * $result['quantity'];
			...
			$data['products'][] = array(
				...
				'my_purchase_price' => $result['my_purchase_price'],
				'my_profit' => $profit,
				'price'      => $result['price'],
		...
		$data['expected_profit'] = round($this->model_catalog_product->getExpectedProfit(),2);
