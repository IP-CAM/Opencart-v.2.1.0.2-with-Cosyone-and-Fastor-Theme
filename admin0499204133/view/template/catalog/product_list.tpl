      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-product">
          <div class="table-responsive">
            ...
            <h5>Планируемый доход: <?php echo $expected_profit;?></h5>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left">Цена по-умолчанию</td>
                  <td class="text-left">Моя цена</td>
                  <td class="text-left">Доход валовый</td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php foreach ($product['category'] as $category_name) { echo $category_name . '<br />'; } ?></td>
                    <td class="text-left"><?php echo $product['default_price']; ?></td>
                  <td class="text-left"><?php echo $product['my_purchase_price']; ?></td>
                    <td class="text-left"><?php echo $product['my_profit']; ?></td>
